...
if(isset($_POST["action"]))
{
	...
	/*if($_POST["action"] == 'Add')
	{
		...
		else
		{
			...
			if($error == '')
			{
				...
				$success = '<div class="alert alert-success">coach ajoute</div>';
			}
		}
	...
	/*if($_POST["action"] == 'Edit')
	{
		...
		else
		{
			...
			if($error == '')
			{
				...
				$success = '<div class="alert alert-success">coach Data Updated</div>';
			}			
		}
	...
	if($_POST["action"] == 'delete')
	{
		...
		echo '<div class="alert alert-success">coach Data Deleted</div>';
	}*/
}
