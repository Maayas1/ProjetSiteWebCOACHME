...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            ?>
            <li class="nav-item">
                <a class="nav-link" href="coach_schedule.php">
                    <i class="fas fa-user-clock"></i>
                    <span>Planning Coach</span></a>
            </li>
            ...
            ?>
            <li class="nav-item">
                <a class="nav-link" href="coach_profile.php">
                    <i class="far fa-id-card"></i>
                    <span>Profil</span></a>
            </li>
            <?php
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        if($_SESSION['type'] == 'Coach')
                        {
                            ...
                            foreach($user_result as $row)
                            {
                                $user_name = $row['coach_name'];
                                $user_profile_image = $row['coach_profile_image'];
                            }
                        }
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="coach_profile.php">
                                    <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Profile
                                </a>
                                <div class="dropdown-divider"></div>
