...
<div class="container-fluid">
	...
	<br />
	<div class="card">
		<div class="card-header"><h4>Planning Coach</h4></div>
			<div class="card-body">
    	...
    	<form method="post" id="appointment_form">
      		<div class="modal-content">
        		<div class="modal-header">
          			<h4 class="modal-title" id="modal_title">Prendre RDV</h4>
        		...
        		<div class="modal-footer">
          			...
          			<input type="hidden" name="hidden_coach_schedule_id" id="hidden_coach_schedule_id" />
...
$(document).ready(function(){
	...
	$(document).on('click', '.get_appointment', function(){
		...
		var coach_schedule_id = $(this).data('coach_schedule_id');
		var coach_id = $(this).data('coach_id');

		$.ajax({
			url:"action.php",
			method:"POST",
			data:{action:'make_appointment', coach_schedule_id:coach_schedule_id},
			success:function(data)
			{
				$('#appointmentModal').modal('show');
				$('#hidden_coach_id').val(coach_id);
				$('#hidden_coach_schedule_id').val(coach_schedule_id);
